...
.pauseFor(1800)
.changeDelay(20)
.typeString('Moi c\'est Teddy')
.pauseFor(300)
.typeString('<strong>, Développeur Junior Front </strong> !')
.pauseFor(1000)
.deleteChars(16)
.typeString('<span style="color: #ff0000;"> ANGULAR</span> !')
.pauseFor(1000)
.deleteChars(2)
.typeString('<span style="color: #0074c2;"> TypeScript </span> !')
.start()
